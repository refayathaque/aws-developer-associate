        ...
        <div className="topics-container">
            ...
            <div className="topics-flex-item-inline">
                ...
                <ul>
                    ...
                    <li>Edge Locations - Situated all over the world - CloudFront uses these to keep a <strong>cache of our web content</strong> (we can also write to it) - Resulting in a much faster response time - Dramatically reduces network hops for each request - <strong>Different from an AWS region/AZ</strong></li>
            ...
            <div className="topics-flex-item-inline">
                ...
                <ul>
                    <li>Amazon S3 Transfer Acceleration enables fast, easy, and secure transfers of files <i>over long distances</i> between your end usrs and an S3 bucket</li>
